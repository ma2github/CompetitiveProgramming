...
signed main(){
    ...
    LL(n,ng1,ng2,ng3);
    ll cnt=0;
    if(n==ng1|n==ng2|n==ng3)return YES(0);
    while(n>3){
      if(n-3==ng1|n-3==ng2|n-3==ng3){if(n-2==ng1|n-2==ng2|n-2==ng3){if(n-1==ng1|n-1==ng2|n-1==ng3)return YES(false);else n-=1;}else n-=2;}else n-=3;
      cnt++;
    }
    YES(cnt<100);
}
